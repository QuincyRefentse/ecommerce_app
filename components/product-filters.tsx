...
const filters = [
  {
    ...
    name: "Category",
    options: [
      { value: "Respiratory products", label: "respiratory products" },
      { value: "Urology products", label: "urology products" },
      { value: "Anesthesiology products", label: "anesthesiology products" },
      { value: "Infusion products", label: "infusion products" },
      { value: "PVC cathers", label: "pvc cathers" },
    ],
  },
